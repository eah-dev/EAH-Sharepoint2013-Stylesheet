...
gulp.task('copy:image', function () {
  ...
  .pipe(gulp.dest('./_catalogs/masterpage/layouts/eah-jena/images'));
});

// gulp.task - 'copy:bootstrapfont'
gulp.task('copy:bootstrapfont', function () {
  return gulp.src('./node_modules/bootstrap-sass/assets/fonts/bootstrap/**')
  .pipe(gulp.dest('./_catalogs/masterpage/layouts/eah-jena/assets/bootstrap/fonts'));
});
...
gulp.task('copy:bootstrapjs', function () {
  ...
  .pipe(gulp.dest('./_catalogs/masterpage/layouts/eah-jena/assets/bootstrap/js'));
});
...
gulp.task('copy:bootstrapcolorpicker', function () {
  ...
  .pipe(gulp.dest('./_catalogs/masterpage/layouts/eah-jena/assets/bootstrap-colorpicker'));
});

// gulp.task - 'copy:fontawesomefonts'
gulp.task('copy:fontawesomefonts', function () {
  return gulp.src('./node_modules/font-awesome/fonts/*')
  .pipe(gulp.dest('./_catalogs/masterpage/layouts/eah-jena/assets/font-awesome/fonts/'));
});

// gulp.task - 'copy:robotofontface'
gulp.task('copy:robotofontface', function () {
  return gulp.src('./node_modules/roboto-fontface/fonts/**')
  .pipe(gulp.dest('./_catalogs/masterpage/layouts/eah-jena/assets/roboto-fontface/fonts/'));
});

// gulp.task - 'copy:ionicons'
gulp.task('copy:ionicons', function () {
  return gulp.src('./node_modules/ionicons/fonts/**')
  .pipe(gulp.dest('./_catalogs/masterpage/layouts/eah-jena/assets/ionicons/fonts/'));
});

// gulp.task - 'copy:jquery'
gulp.task('copy:jquery', function () {
  return gulp.src('./node_modules/jquery/dist/jquery.min.js')
  .pipe(gulp.dest('./_catalogs/masterpage/layouts/eah-jena/assets/jquery/'));
});
